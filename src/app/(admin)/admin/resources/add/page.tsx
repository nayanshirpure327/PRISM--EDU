...
import { ArrowLeft, Save, Send, Link as LinkIcon, UploadCloud } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      <div className="flex items-center gap-3 border-b border-slate-200 pb-4">
        ...
        <div>
          <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Create Institutional Resource</h2>
          <p className="text-sm text-slate-500">
            Publish educational materials, scholarships, support channels, or career opportunities with targeting rules.
          </p>
        </div>
      </div>
        ...
        <Card className="border-slate-200">
          ...
          <CardContent className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <Input
              ...
              placeholder="e.g. Math Department, Scholarship Board"
            />
